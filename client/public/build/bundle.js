...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 56, 1, 1143);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*downloadBuffs*/ ctx[0], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("thisBuff" in $$props) thisBuff = $$props.thisBuff;
    		if ("buffs" in $$props) buffs = $$props.buffs;
    		if ("trinkets" in $$props) trinkets = $$props.trinkets;
    	};
